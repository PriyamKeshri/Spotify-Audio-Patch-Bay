...
interface PlayerState {
  ...
  // Surfaced when a playback command 404s with NO_ACTIVE_DEVICE, and
  // cleared as soon as a command succeeds or a device is picked.
...
export const usePlayerStore = create<PlayerState>((set, get) => ({
  ...
  setDeviceMenuOpen: (deviceMenuOpen) => set({ deviceMenuOpen }),
