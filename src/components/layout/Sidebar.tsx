...
import { Compass, Heart, Home, Library, ListMusic, Search } from 'lucide-react';
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-console-800 bg-console-950 lg:flex">
      ...
      <div className="flex min-h-0 flex-1 flex-col px-3">
        <div className="flex items-center gap-2 px-3 pb-2 font-mono text-[10px] uppercase tracking-widest text-console-500">
